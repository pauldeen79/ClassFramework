...
{
    public override Task<Result<IEnumerable<TypeBase>>> GetModelAsync(CancellationToken cancellationToken) => GetNonGenericBuilders(GetAbstractModels(), "ClassFramework.Domain.Builders", "ClassFramework.Domain");
