...
{
    public override Task<Result<IEnumerable<TypeBase>>> GetModelAsync(CancellationToken token) => GetBuildersAsync(GetTestModelsAsync(), "ClassFramework.TemplateFramework.Tests.Builders", "ClassFramework.TemplateFramework.Tests");
