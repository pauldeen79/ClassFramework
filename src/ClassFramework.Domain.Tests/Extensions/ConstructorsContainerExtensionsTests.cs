...
public class ConstructorsContainerExtensionsTests : TestBase
{
    public class HasPublicParameterlessConstructor : ConstructorsContainerExtensionsTests
    {
        ...
        public void Returns_True_When_A_Public_Constructor_Is_Defined_Without_Any_Parameters()
        {
            // Arrange
            var sut = Fixture.Freeze<IConstructorsContainer>();
            sut.Constructors.Returns(new[] { new Constructor(string.Empty, default, default, default, default, default, Domains.Visibility.Public, Enumerable.Empty<Attribute>(), Enumerable.Empty<CodeStatementBase>(), Enumerable.Empty<Parameter>(), Enumerable.Empty<string>()) });
        ...
        public void Returns_False_When_A_Private_Constructor_Is_Defined_Without_Any_Parameters()
        {
            // Arrange
            var sut = Fixture.Freeze<IConstructorsContainer>();
            sut.Constructors.Returns(new[] { new Constructor(string.Empty, default, default, default, default, default, Domains.Visibility.Private, Enumerable.Empty<Attribute>(), Enumerable.Empty<CodeStatementBase>(), Enumerable.Empty<Parameter>(), Enumerable.Empty<string>()) });
