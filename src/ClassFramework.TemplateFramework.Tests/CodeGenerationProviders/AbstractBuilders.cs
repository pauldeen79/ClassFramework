...
{
    public override Task<Result<IEnumerable<TypeBase>>> GetModelAsync(CancellationToken cancellationToken) => GetBuilders(GetAbstractModels(), "Test.Domain.Builders", "Test.Domain");
