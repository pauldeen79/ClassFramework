...
{
    public override Task<Result<IEnumerable<TypeBase>>> GetModelAsync(CancellationToken token) => GetNonGenericBuildersAsync(GetAbstractModelsAsync(), "Test.Domain.Builders", "Test.Domain");
