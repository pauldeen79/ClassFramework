...
public sealed class IntegrationTests : TestBase, IDisposable
{
    ...
    public IntegrationTests()
    {
        ...
        _serviceProvider = new ServiceCollection()
            ...
            .AddClassFrameworkCodeGenerators(typeof(IntegrationTests).GetAssemblyGeneratorTypes<ImmutablePrivateSettersCSharpClassBase>())
            .AddClassFrameworkCodeGenerators(typeof(IntegrationTests).GetAssemblyGeneratorTypes<ImmutableUseBuilderAbstractionsTypeConversionCSharpClassBase>())
            .AddClassFrameworkCodeGenerators(typeof(IntegrationTests).GetAssemblyGeneratorTypes<MappedCSharpClassBase>())
            .AddClassFrameworkCodeGenerators(typeof(IntegrationTests).GetAssemblyGeneratorTypes<MultipleInterfacesBase>())
            .AddClassFrameworkCodeGenerators(typeof(IntegrationTests).GetAssemblyGeneratorTypes<ObservableCSharpClassBase>())
            .AddClassFrameworkCodeGenerators(typeof(IntegrationTests).GetAssemblyGeneratorTypes<CsharpClassGeneratorCodeGenerationProviderBase>())
            .AddClassFrameworkCodeGenerators(typeof(IntegrationTests).GetAssemblyGeneratorTypes<CsharpClassGeneratorPipelineCodeGenerationProviderBase>())
...
");
    ...
    {
        public override Task<Result<IEnumerable<TypeBase>>> GetModelAsync(CancellationToken token) => Task.FromResult(
