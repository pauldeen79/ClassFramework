...
public static class ServiceCollectionExtensions
{
    ...
    private static IServiceCollection AddSharedPipelineComponents(this IServiceCollection services)
        => services
            ...
            .AddSingleton<IFunction, CsharpFriendlyNameFunction>()
            .AddSingleton<IFunction, CsharpFriendlyTypeNameFunction>()
            .AddSingleton<IFunction, GenericArgumentsFunction>()
            .AddSingleton<IFunction, InstancePrefixFunction>()
