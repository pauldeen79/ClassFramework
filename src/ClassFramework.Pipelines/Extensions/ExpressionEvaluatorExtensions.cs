    ...
    private static IReadOnlyDictionary<string, Task<Result<object?>>> CreateState(object context)
    {
        ...
        if (context is BuilderContext builderContext)
        {
            builder
                ...
                .Add("typename", builderContext.MapTypeName(builderContext.SourceModel.GetFullName(), string.Empty))
        ...
        else if (context is BuilderExtensionContext builderExtensionContext)
        {
            builder
                ...
                .Add("typename", builderExtensionContext.MapTypeName(builderExtensionContext.SourceModel.GetFullName(), string.Empty))
        ...
        else if (context is EntityContext entityContext)
        {
            builder
                ...
                .Add("typename", entityContext.MapTypeName(entityContext.SourceModel.GetFullName(), string.Empty))
        ...
        else if (context is InterfaceContext interfaceContext)
        {
            builder
                ...
                .Add("typename", interfaceContext.MapTypeName(interfaceContext.SourceModel.GetFullName(), string.Empty))
        ...
        else if (context is Reflection.ReflectionContext reflectionContext)
        {
            builder
                ...
                .Add("typename", reflectionContext.MapTypeName(reflectionContext.SourceModel.FullName, string.Empty))
        ...
        else if (context is ParentChildContext<PipelineContext<BuilderContext>, Property> parentChildContextBuilder)
        {
            builder
                ...
                .Add("typename", parentChildContextBuilder.ParentContext.Request.MapTypeName(parentChildContextBuilder.ParentContext.Request.SourceModel.GetFullName(), string.Empty))
        ...
        else if (context is ParentChildContext<PipelineContext<BuilderExtensionContext>, Property> parentChildContextBuilderExtension)
        {
            builder
                ...
                .Add("typename", parentChildContextBuilderExtension.ParentContext.Request.MapTypeName(parentChildContextBuilderExtension.ParentContext.Request.SourceModel.GetFullName(), string.Empty))
        ...
        else if (context is ParentChildContext<PipelineContext<EntityContext>, Property> parentChildContextEntity)
        {
            builder
                ...
                .Add("typename", parentChildContextEntity.ParentContext.Request.MapTypeName(parentChildContextEntity.ParentContext.Request.SourceModel.GetFullName(), string.Empty))
