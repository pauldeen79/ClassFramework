...
public class InterfacePipelinePlaceholderProcessor : IPlaceholderProcessor
{
    ...
    private Result<FormattableStringParserResult> GetResultForPipelineContext(string value, IFormatProvider formatProvider, IFormattableStringParser formattableStringParser, PipelineContext<InterfaceBuilder, InterfaceContext> pipelineContext)
        => value switch
        {
    ...
    private Result<FormattableStringParserResult> GetResultForParentChildContext(string value, IFormatProvider formatProvider, IFormattableStringParser formattableStringParser, ParentChildContext<PipelineContext<InterfaceBuilder, InterfaceContext>, Property> parentChildContext)
        => value switch
        {
