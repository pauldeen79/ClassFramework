...
public class PropertyProcessor : IPipelinePlaceholderProcessor
{
    ...
    public Result<string> Process(string value, IFormatProvider formatProvider, object? context, IFormattableStringParser formattableStringParser)
    {
        ...
        return value switch
        {
            ...
            "BuilderMemberName" => Result.Success(propertyContext.SourceModel.GetBuilderMemberName(propertyContext.Settings.AddNullChecks, propertyContext.Settings.EnableNullableReferenceTypes, propertyContext.Settings.ValidateArguments, propertyContext.Settings.AddBackingFields || propertyContext.Settings.CreateAsObservable, propertyContext.FormatProvider.ToCultureInfo())),
