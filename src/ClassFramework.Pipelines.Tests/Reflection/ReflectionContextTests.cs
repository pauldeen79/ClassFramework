...
public class ReflectionContextTests : TestBase
{
    public class Constructor : ReflectionContextTests
    {
        ...
        {
            // Act & Assert
            Action a = () => _ = new GenerateTypeFromReflectionCommand(sourceModel: null!, new PipelineSettingsBuilder(), CultureInfo.InvariantCulture, CancellationToken.None);
        ...
        {
            // Act & Assert
            Action a = () => _ = new GenerateTypeFromReflectionCommand(sourceModel: GetType(), settings: null!, CultureInfo.InvariantCulture, CancellationToken.None);
        ...
        {
            // Act & Assert
            Action a = () => _ = new GenerateTypeFromReflectionCommand(sourceModel: GetType(), new PipelineSettingsBuilder(), formatProvider: null!, CancellationToken.None);
    ...
    public class MapAttribute : ReflectionContextTests
    {
        ...
        public void Throws_On_Null_TypeName()
        {
            ...
            var sut = new GenerateTypeFromReflectionCommand(GetType(), settings, CultureInfo.InvariantCulture, CancellationToken.None);
