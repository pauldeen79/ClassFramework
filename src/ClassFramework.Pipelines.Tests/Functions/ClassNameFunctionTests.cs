...
{
    public class Parse : ClassNameFunctionTests
    {
        [Fact]
        ...
        public void Returns_Invalid_When_No_Arguments_Are_Provided()
        {
            ...
            result.ErrorMessage.Should().Be("ClassName function requires one argument");
        }
        ...
        public void Returns_Invalid_When_Argument_ValueResult_Is_Not_Of_Type_String()
        {
            ...
            // Assert
            result.Status.Should().Be(ResultStatus.Invalid);
            result.ErrorMessage.Should().Be("ClassName function does not support type System.Int32, only string is supported");
        }
        ...
        public void Returns_Invalid_When_Argument_ValueResult_Is_Null()
        {
            ...
            // Assert
            result.Status.Should().Be(ResultStatus.Invalid);
            result.ErrorMessage.Should().Be("ClassName function requires argument of type string, but the value was null");
        }
