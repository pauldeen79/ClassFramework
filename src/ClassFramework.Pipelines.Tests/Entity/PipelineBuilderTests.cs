    ...
    public class IntegrationTests : PipelineBuilderTests
    {
        ...
        public async Task Creates_Observable_Entity_With_NamespaceMapping()
        {
            ...
            (
                ...
                "bool hasChanged = !EqualityComparer<System.Nullable<System.Int32>>.Default.Equals(_property2, value);",
                "_property2 = value;",
                "if (hasChanged) HandlePropertyChanged(nameof(Property2));",
                "bool hasChanged = !EqualityComparer<System.String>.Default.Equals(_property3, value);",
                "_property3 = value ?? throw new System.ArgumentNullException(nameof(value));",
                "if (hasChanged) HandlePropertyChanged(nameof(Property3));",
                "bool hasChanged = !EqualityComparer<System.String>.Default.Equals(_property4, value);",
                "_property4 = value;", "if (hasChanged) HandlePropertyChanged(nameof(Property4));",
                "bool hasChanged = !EqualityComparer<MyNamespace.MyClass>.Default.Equals(_property5, value);",
                "_property5 = value ?? throw new System.ArgumentNullException(nameof(value));",
                "if (hasChanged) HandlePropertyChanged(nameof(Property5));",
                "bool hasChanged = !EqualityComparer<MyNamespace.MyClass>.Default.Equals(_property6, value);",
                "_property6 = value;",
                "if (hasChanged) HandlePropertyChanged(nameof(Property6));",
                "bool hasChanged = !EqualityComparer<System.Collections.ObjectModel.ObservableCollection<MyNamespace.MyClass>>.Default.Equals(_property7, value);",
                "_property7 = value ?? throw new System.ArgumentNullException(nameof(value));",
                "if (hasChanged) HandlePropertyChanged(nameof(Property7));",
                "bool hasChanged = !EqualityComparer<System.Collections.ObjectModel.ObservableCollection<MyNamespace.MyClass>>.Default.Equals(_property8, value);",
