...
//            result.ErrorMessage.ShouldBe("Could not get class from context, because the context type System.Object is not supported");
//        }
...
//            // Assert
//            result.Status.ShouldBe(ResultStatus.NotSupported);
//            result.ErrorMessage.ShouldBe("Could not get class from context, because the context type null is not supported");
//        }
